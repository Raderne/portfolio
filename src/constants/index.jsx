...
export const projectsData = [
	...
	},
	{
		name: "Inventory View",
		description:
			"Inventory Management System is a Laravel project that allows users to manage products and orders in a MySQL database. It has a login form that authenticates users. Users can add and remove products and orders, also can only view products and suppliers.",
		skills: [
			"Laravel",
			"MySQL",
			"HTML5",
		...
		code: "https://github.com/Raderne/inventory-view-laravel",
		demo: "",
		images: [
			inventoryviewSc1,
			inventoryviewSc2,
	...
	},
	{
		...
		description:
			"A website for a restaurant built with React for frontend and .net core for backend using SQL Server for the database and JWT for authentication as well as using Clean Architecture.",
		skills: ["React", "ASP.Net", "MS SQL", "C#"],
		code: "https://github.com/Raderne/Restaurants-net-core",
		demo: "",
		images: [],
		phone: [],
		Icon: SiDotnet,
